    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable<LoggedRoutes.Characters> {
                // Se crea una instancia del ViewModel para la lista de personajes.
            ...
            composable<LoggedRoutes.CharacterProfile> { backStackEntry ->
                // 2. CORRECCIÓN: Obtiene el ID del personaje de la ruta
                val characterId = backStackEntry.toRoute<LoggedRoutes.CharacterProfile>().characterId

                // 3. CORRECCIÓN: Obtiene la entrada del backstack de la pantalla de la lista
                val parentEntry = remember(backStackEntry) {
                    navController.getBackStackEntry(LoggedRoutes.Characters)
                }

                // 4. CORRECCIÓN: Obtiene el ViewModel compartido pasándole el 'parentEntry'
